CREATE DATABASE automobile_database;
...
CREATE TABLE AutomobileOption(OptionId INT NOT NULL,OptionName varchar(255) NOT NULL,OptionPrice FLOAT NOT NULL,OptionSetId INT NOT NULL,AutoID INT NOT NULL,PRIMARY KEY (OptionId),FOREIGN KEY (OptionSetId) REFERENCES OptionSet(OptionSetId));